...
if(loading){
    ...
    return (
    <div>
        { ordenId ? <p style={{textAlign:'center',fontWeight: 'bold',color:'green'}}> Generaste con éxito tu solicitud, su numero de seguimiento es:  {ordenId} </p>  :<div>
            <h2>Checkout</h2>
            <form onSubmit={handleSubmit(handleOrder)}>
                ...
                {errors?.email?.type === 'required' && <p>El mail es obligatorio</p>}
                ...
                {errors?.email2?.type === 'required' && <p>El mail es obligatorio</p>}
                {errors?.email2?.type === 'minLength' && <p>El mail es demasiado corto</p> }
                {errors?.email2?.type ==='equalsMails' && <p>Los mails no deben ser distintos</p>}
